...
async function fetchModels(provider) {
  ...
  else if (provider.type === 'claude') { url = `${baseUrl}/v1/models`; headers = { 'x-api-key': provider.apiKey, 'anthropic-version': '2023-06-01' }; }
...
module.exports = { chat, cancel, fetchModels, getQueueStatus };